...
namespace financial_management
{
    public partial class Transactions : Form
    {
        ...
        private void Submit_Transaction(object sender, EventArgs e)
        {
            ...
            if (name == null || amount == null || comTransCategory.SelectedIndex == -1 || comTransType.SelectedIndex == -1)
            {
            ...
            if (result == true)
            {
                ...
                MessageBox.Show("Transaction Complete", "Hey", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
